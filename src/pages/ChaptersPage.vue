...
const filterOptions = [
  {
    ...
    queryName: 'findChaptersByProjectId'
  },
  {
    table: 'books',
    label: 'Books',
    queryName: 'findChaptersByBookId'
  }
];
    ...
    <div class="row">
      ...
      <div class="col-8">
        ...
        <div v-else class="q-pl-xs">
          <c-form-header :title="$t('generic.chapter')" />
          <div class="q-pa-md">
          ...
          <c-form-children v-if="form.dataset.value.id"
                           ...
                           :parent="$t('generic.chapter')"
                           :plural="$t('generic.scenes')"
                           :singular="$t('generic.scenes')"
                           table="scenes"/>
        </div>
      </div>
    </div>
